...
final class Image_API {
	 ...
	 */
	const BASE_URL       = 'https://categories.api.godaddy.com/v3/';
	...
	public function __construct() {
		...
		$this->image_cat_url    = 'https://categories.api.godaddy.com/v3/photos/en_us/latest/%s/';
		$this->category_api_url = 'https://categories.api.godaddy.com/v3/categories/en_us/latest/';
