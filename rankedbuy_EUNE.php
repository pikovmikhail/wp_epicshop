...
$data= $wpdb->get_row("select * from wp_w5bfvg74x5_postmeta where post_id='230' AND meta_key='1_dh_ptp_settings'");
...
if($planprice !="")
{
    ...
    $query['quantity_1'] = '1';
    //$query['amount_1'] = str_replace("€","",$planprice);//$planprice;€
	$query['amount_1'] = str_replace("$","",$planprice);
